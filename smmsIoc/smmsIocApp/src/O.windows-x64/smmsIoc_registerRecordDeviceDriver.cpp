...
/* Generated from ../O.Common/smmsIoc.dbd */
...
static const char * const deviceSupportNames[] = {
    ...
    "asynFloat64TimeSeries", "devwaveformStream", "devXxxSoft"
};
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devwaveformStream, pvar_dset_devXxxSoft
};
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_chamberRegistrar, pvar_func_dbndInitialize,
    pvar_func_drvAsynIPPortRegisterCommands,
    pvar_func_drvAsynSerialPortRegisterCommands, pvar_func_gaugeRegistrar,
    pvar_func_helloRegister, pvar_func_initTraceRegister,
    pvar_func_motorRegistrar, pvar_func_sncExampleRegistrar,
    pvar_func_streamRegistrar, pvar_func_syncInitialize,
    pvar_func_tsInitialize, pvar_func_voltageRegistrar,
...
int smmsIoc_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "E:/epics_for_win/smmsIoc";
...
/* smmsIoc_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"smmsIoc_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    smmsIoc_registerRecordDeviceDriver(*iocshPpdbbase);
}
