 ...
 *
 * Created from
 *   C:/epics_for_win/base/base-3.15.5/src/libCom/env/envDefs.h
 *   C:/epics_for_win/base/base-3.15.5/configure/CONFIG_ENV
 *   C:/epics_for_win/base/base-3.15.5/configure/CONFIG_SITE_ENV
 */
